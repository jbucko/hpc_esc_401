...
data01 = np.hstack((data_arr[0],data_arr[1]))
data23 = np.hstack((data_arr[2],data_arr[3]))
dataAll = np.vstack((data01,data23))

source01 = np.hstack((source_arr[0],source_arr[1]))
source23 = np.hstack((source_arr[2],source_arr[3]))
sourceAll = np.vstack((source01,source23))


print(data01.shape)
print(data23.shape)
print(dataAll.shape)
print(sourceAll.shape)


# data = datdat.reshape(161,161)
# source = sourcedat.reshape(161,161)
